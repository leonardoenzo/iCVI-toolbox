% PROGRAM DESCRIPTION
% This is a MATLAB implementation of batch and incremental WB-index (WB)
...
classdef CVI_WB 
    properties (Access = public)       
        ...
        CriterionValue = [];        % calculated WB index
    end 
    methods 
        ...
        function obj = evaluate(obj) 
            ...
            if obj.nClusters > 1
                ...
                obj.CriterionValue = (obj.WGSS/obj.BGSS)*obj.nClusters; % WB index value  
            end
        end   
    end
end